...
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
	<h3 style="text-align:center"><b>이용후기 작성</b></h3>
	<br>
	...
	<form:form action="write.do" id="register_form" 
		...
		<ul>
			...
			<li>
				...
				<form:radiobutton path="r_rate" value="5" id="status5" checked="checked"/><span style="vertical-align:2px;">★★★★★</span>
		...
		<div class="align-center">
			...
			<input type="button" value="목록"  class="btn btn-outline-secondary btn-sm" onclick="location.href='list.do'">
		</div>	                   
	</form:form>
	</div>
</div>
