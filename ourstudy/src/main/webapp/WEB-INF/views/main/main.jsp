      ...
      <li class="mb-1">
        ...
        <div class="collapse show" id="home-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">여기에</a></li>
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">상세항목</a></li>
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">작성하면 됨</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
