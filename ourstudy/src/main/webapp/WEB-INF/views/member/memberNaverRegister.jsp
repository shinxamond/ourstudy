...
<div class="register-main">
	<form:form action="registerNaverUser.do" id="register_form" modelAttribute="memberVO" style="min-height:690px;">
		...
		<input type="hidden" id="kakaocheck" name="navercheck" value="${naver_email}">
		<input type="hidden" id="mem_name" name="mem_name" value="${naver_name}">
