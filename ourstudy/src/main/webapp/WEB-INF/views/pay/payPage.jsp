...
<h4>${user.mem_id}님의 이용권 선택내역</h4>
	<form id="ticketDetail" action="payPage.do" method="post">
		...
		<div class="container border border-primary" style="background-color: #E4F7BA;">
			<h6 style="margin-top:5px;"><span id="ticket_name" data-ticketname="${ticket.ticket_name}">${ticket.ticket_name}</span><span style="float:right;"><fmt:formatNumber value="${ticket.ticket_price}"/>원</span></h6>
