	...
	<div class="page-main">	
		<div class="content-main"><!-- 전체 화면의 87% -->
			...
			<div class="content-right">
				<h3 style="text-align:center"><b>발신채팅히스토리</b></h3>
				<!-- 검색폼 시작 -->
				<div class="section" style="text-align:center"> 
					<div class="search-bar">
						<form class="search-form d-flex align-items-center" action="admin_sendhistory.do" method="get"><!-- 자동 인코딩 처리를 위해 -->
							<select class="form-select" id="form-select1" name="keyfield" aria-label="form-select"
									onchange="location.href='admin_sendhistory.do?keyfield='+this.value">
				...
				<c:if test="${count>0}">
					<table class="table table-hover align-center" id="t1">
						...
						<tbody class="table-body table-group-divider">
							<c:forEach var="history" items="${adminSendList}" varStatus="status"><!-- var는 자바빈(VO) -->
							<tr>
					...
					<table class="table table-hover table-group-divider" id="t2">
						<c:forEach var="history" items="${adminSendList}">
						<tr>
							<td>
								<div>
