...
<div class = "mypage_mem_info_modify">
	<div class = "wrap-meminfo">
		...
		<div class = "mem-info-content">
			<table>
				...
				<tr>
					<th>전화번호</th>
					<td>
						<form:input path="mem_phone" oninput="numberphone(this)" class = "mem_phone input-textbox"  maxlength="13" placeholder=" 숫자만 입력하세요"/>
		...
		<div style = "text-align : center; margin-bottom: 30px;">
			...
			<input type="button" class="btn" id="list_btn" value="홈으로" onclick="location.href='${pageContext.request.contextPath}/mypage/myPageMain.do'">
		</div>
		</form:form>
	</div>
