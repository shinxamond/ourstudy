...
public interface LockerMapper {
   ...
   //현재 쓰고 있는 사물함 만료날짜 불러오기
   @Select("SELECT TO_CHAR(d.locker_end , 'YYYY-MM-DD') FROM (SELECT * FROM LOCKER_DETAIL WHERE mem_num=#{mem_num} ORDER BY locker_end DESC) d WHERE rownum=1")
